    ...
    private static void SetData()
    {
        try
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                ...
                var client = new Client($"Name{i}", $"Surname{i}", new DateTime(2003, 10, 12),
        ...
        // for (var i = 0; i < 100; i++)
        // {
        //     repository.Add(new Analysis($"title{i}", new TimeSpan(2, 0, 0, 0), new TimeSpan(0, 0, i + 1, 0), (i+ 1).ToString()));
        // }

        // try
        // {
        //
        //     MedicinesRepository repository = MedicinesRepository.GetInstance();
        //     for (int i = 0; i < 101; i++)
        //     {
        //         Medicines med = new Medicines($"title{i}", $"introduction{i}",
        //             $"manufact{i}", (i % 2) switch
        //             {
        //                 0 => true,
        //                 1 => false,
        //                 _ => false
